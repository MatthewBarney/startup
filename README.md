...
- [x] **Rented EC2 server** - yes .
- [x] **Leased domain name** - yes my domain name is the6dchess.com.
- [x] **Server accessible** from my domain: [https://the6dchess.com](https://the6dchess.com) 
